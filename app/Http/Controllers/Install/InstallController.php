...
class InstallController extends Controller
{
    ...
    public function runMigrate(Request $request)
    {
        ...
        // A fresh install runs every migration in one request; each
        // ALTER TABLE ... FOREIGN KEY can take a second or more, so the
        // cumulative time easily exceeds PHP's default max_execution_time.
        // Lift the limit for this one-time, token-gated install step.
        set_time_limit(0);

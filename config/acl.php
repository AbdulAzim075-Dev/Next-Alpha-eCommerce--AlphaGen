...
return [
    'permissions' => [
        ...
        'admin' => [
            ...
            'weightWiseDeliveryCharge' => ['index', 'create', 'edit', 'destroy'],
            'support-item' => ['index', 'update'],
        ],
        'shop' => [
            ...
            'bulk-product-export' => ['index', 'export'],
            'gallery' => ['index', 'store'],
    ...
    'customerReadableNames' => [
        ...
        'metaPixelEvent' => 'meta pixel event log',

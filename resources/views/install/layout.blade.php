...
<head>
    ...
    <title>@yield('title', 'Install') — {{ config('app.name', 'Next Alpha eCommerce') }}</title>
    <style>
...
<body>
    ...
    <img class="logo" src="{{ asset('assets/logo.png') }}" alt="{{ config('app.name', 'Next Alpha eCommerce') }}">
    ...
    <div class="footer-note">{{ config('app.name', 'Next Alpha eCommerce') }} installer</div>
</body>
</html>

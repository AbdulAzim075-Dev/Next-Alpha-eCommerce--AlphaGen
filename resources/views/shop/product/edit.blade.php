    ...
    <form action="{{ route('shop.product.update', $product->id) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="card mt-3">
            <div class="card-body">
                ...
                @php
                    $hasSecondaryProduct = (bool) (old('name_secondary', $product->name_secondary) || old('short_description_secondary', $product->short_description_secondary) || old('description_secondary', $product->description_secondary));
                @endphp

                <div class="d-flex align-items-center justify-content-between mb-2">
                    <span class="fz-18">{{ __('Product Info') }}</span>
                    <x-secondary-lang-toggle for="product-edit" :checked="$hasSecondaryProduct" />
                </div>
                ...
                <x-secondary-lang-fields for="product-edit" :show="$hasSecondaryProduct">
                    <div class="mt-3">
                        <x-input label="{{ __('Product Name') }} ({{ secondary_language_title() }})" name="name_secondary" id="product_name_secondary" type="text"
                            placeholder="{{ secondary_language_title() }} Product Name" :value="old('name_secondary', $product->name_secondary)" />
                    </div>
                ...
                <x-secondary-lang-fields for="product-edit" :show="$hasSecondaryProduct">
                    <div class="mt-3">
                        ...
                        <textarea name="short_description_secondary" class="form-control" id="short_description_secondary" rows="2"
                            placeholder="{{ __('Short Description') }} ({{ secondary_language_title() }})">{{ old('short_description_secondary', $product->short_description_secondary) }}</textarea>
                ...
                <x-secondary-lang-fields for="product-edit" :show="$hasSecondaryProduct">
                    <div class="mt-4">
                        ...
                        <div id="editor_secondary" style="max-height: 750px; min-height: 200px; overflow-y: auto">
                            {!! old('description_secondary', $product->description_secondary) !!}
                        </div>
                        <input type="hidden" id="description_secondary" name="description_secondary"
                            value="{{ old('description_secondary', $product->description_secondary) }}">
                        ...
                        <div class="row mt-3">
                            ...
                            @if ($product->is_digital == false)
                                <div class="col-md-6 col-lg-4 mt-4">
                                    ...
                                    <select name="colorIds[]" data-placeholder="Select Color"
                                        class="form-control colorSelect" multiple style="width: 100%">
                                        <option value="">
                                            {{ __('Select Color') }}
                                        </option>
                                ...
                                <div class="col-md-6 col-lg-4 mt-4">
                                    ...
                                    <select name="sizeIds[]" data-placeholder="Select Size"
                                        class="form-control sizeSelector" multiple style="width: 100%">
                                        <option value="">
                                            {{ __('Select Size') }}
                                        </option>
                            ...
                            <div class="col-md-6 col-lg-4 mt-4">
                                <x-input type="text" name="product_weight" label="Product Weight (in kg)"
                                    placeholder="Product Weight" onlyNumber="true" :value="$product->product_weight" />
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card mt-4 mb-3 {{ $product->is_digital == true ? 'd-block' : 'd-none' }}"
                    id="digitalProductSection">
                    <div class="card-body">
                            ...
                            <div class="card h-100">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex flex-wrap gap-3 pt-3" id="digitalAttachments">
                                        ...
                                        <!-- previous additional attachment -->
                                        @foreach ($product->attachments as $attachment)
                                            ...
                                            <div id="attachmentShow">
                                                <label for="attachmentPreviousThumbnailShow{{ $attachment->id }}"
                                                    class="digitalAttachmentLebel">
                                                    <img src="{{ $source }}"
                                                        id="attachmentPreviewShow{{ $attachment->id }}" alt="thumbnail"
                                                        width="100%" height="100%">
                                                    <a href="{{ route('shop.product.remove.attachment', ['product' => $product->id, 'media' => $attachment->id]) }}"
                                                ...
                                                <input type="hidden"
                                                    name="attachmentPreviousThumbnail[{{ $loop->index }}][id]"
                                                    value="{{ $attachment->id }}">
                                            </div>
                                        @endforeach
                                    </div>
                        ...
                        <div class="card mt-3">
                            <div class="card-body">
                                ...
                                @if ($product->licenses->count() >= 1)
                                    <div id="licenseList" class="license-list mb-2">
                                        @foreach ($product->licenses as $license)
                                            <div class="license-row">
                                                <input name="previous_license_key[{{ $license->id }}]" type="text"
                                                    placeholder="License Key" class="license-text"
                                                    value="{{ $license->product_license }}" />
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-lg-4 col-md-6 mt-5 mt-md-0">
                                ...
                                <select name="discount_type" class="form-select mt-2" >
                                    <option value="0" {{ $product->discount_type == 0 ? 'selected' : '' }}>
                                        {{ __('Percent') }}
                                    </option>
                            ...
                            <div class="col-lg-4 col-md-6 mt-3">
                                <x-input type="text" name="discount" label="Discount" min="0"
                                    placeholder="Discount Price" onlyNumber="true" :value="$product->discount" />
                            </div>
                            {{-- <div class="col-lg-4 col-md-6 mt-3 mt-md-0">
                                <x-input type="text" name="discount_price" disabled label="Discount Price"
                                        ...
                                        <tr id="selectedColorRow_{{ $color->id }}"
                                                ...
                                                <td>
                                                    <div class="colorImgBox">
                                                        <x-image-picker name="color[{{ $color->id }}][color_img]"
                                                            :value="$color->pivot->img" />
                                                    </div>
                                                </td>
                                                <td>
                                                    <button class="btn circleIcon btn-outline-danger btn-sm"
                                                        type="button" onclick="deleteColorRow({{ $color->id }})">
                                    ...
                                    <tbody id="selectedSizesTableBody">
                                        @foreach ($product->sizes as $size)
                                            <tr id="selectedSizeRow_{{ $size->id }}">
                                                ...
                                                <td>
                                                    <button class="btn circleIcon btn-outline-danger btn-sm"
                                                        type="button" onclick="deleteSizeRow({{ $size->id }})">
                                                        <i class="fa-solid fa-times"></i>
                                                    </button>
                                                </td>
                                            </tr>
                ...
                <div class="row mb-3">
                    <div class="col-md-5 col-xl-3">
                        <div class="card card-body h-100" style="display:inline-block">
                            ...
                            <x-image-picker name="thumbnail" :value="$product->product_thumbnail ?? $product->thumbnail" />
                        </div>
                    </div>
                                ...
                                <div class="d-flex flex-wrap gap-2" id="additionalElements">
                                    ...
                                    @foreach ($product->medias as $media)
                                        <div class="thumbnail-wrapper d-flex flex-column align-items-start gap-1">
                                            ...
                                            <x-image-picker name="additionThumbnail[]" :value="$media->thumbnail ?? $media->media?->src" />
                                        </div>
                                    @endforeach
...
@push('scripts')
    ...
    <script>
        ...
        const fileIcons = {
            ...
            'zip': "https://cdn-icons-png.flaticon.com/512/337/337960.png",
            'csv': "https://cdn-icons-png.flaticon.com/512/337/337936.png",
            'xls': "https://cdn-icons-png.flaticon.com/512/337/337936.png",
            'xlsx': "https://cdn-icons-png.flaticon.com/512/337/337936.png",
            'mp3': "https://cdn-icons-png.flaticon.com/512/337/337938.png",
            'wav': "https://cdn-icons-png.flaticon.com/512/337/337938.png",
            'mp4': "https://cdn-icons-png.flaticon.com/512/337/337959.png",
            'avi': "https://cdn-icons-png.flaticon.com/512/337/337959.png",
            'default': "https://cdn-icons-png.flaticon.com/512/337/337957.png"
        };
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            const licenseLists = document.querySelectorAll('#licenseList');
            const licenseList = licenseLists[licenseLists.length - 1];

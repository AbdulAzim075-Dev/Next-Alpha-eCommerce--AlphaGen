            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-lg-8">
                        ...
                        @php
                            $hasSecondaryBlog = (bool) (old('title_secondary') || old('description_secondary'));
                        @endphp
                        <x-secondary-lang-toggle for="blog-create" :checked="$hasSecondaryBlog" />

                        <x-secondary-lang-fields for="blog-create" :show="$hasSecondaryBlog">
                            <div class="mt-3">
                                <x-input label="{{ __('Title') }} ({{ secondary_language_title() }})" name="title_secondary" type="text"
                                    placeholder="Enter {{ secondary_language_title() }} title" :value="old('title_secondary')" />
                            </div>

        ...
        <div class="card mt-3">
            <div class="card-body">
                <div class="row">
                    <div class="col-lg-8">
                        <div class="">
                            <x-input label="Title" name="title" type="text" id="title" placeholder="Enter Title"
                    ...
                    <div class="col-lg-4">
                        ...
                        <x-image-picker name="thumbnail" :value="$blog->blog_thumbnail ?? $blog->thumbnail" />

                        {{-- <label for="thumbnail" class="blogThumbnail">
                            <img src="{{ $blog->thumbnail ?? 'https://placehold.co/880x440/f1f5f9/png' }}" id="preview"

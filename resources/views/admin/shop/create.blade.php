    ...
    <form action="{{ route('admin.shop.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="card mt-4 mb-4">
            <div class="card-body">
                ...
                @php
                    $hasSecondaryShop = (bool) old('name_secondary');
                @endphp
                ...
                <div class="d-flex gap-2 align-items-center border-bottom pb-2">
                    ...
                    <x-secondary-lang-toggle for="shop-create" class="ms-auto" :checked="$hasSecondaryShop" />
                </div>
                <div class="row mt-3">
                    <div class="col-md-4">
                ...
                <div class="row mt-3">
                    <div class="col-md-4">
                        <x-secondary-lang-fields for="shop-create" :show="$hasSecondaryShop">

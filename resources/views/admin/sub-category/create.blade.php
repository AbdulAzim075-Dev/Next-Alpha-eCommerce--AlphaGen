            ...
            <div class="col-lg-8 m-auto">
                <div class="card mt-3">
                    <div class="card-body">
                        ...
                        @php
                            $hasSecondarySub = (bool) (old('name_secondary') || old('short_description_secondary'));
                        @endphp
                        ...
                        <div class="d-flex gap-2 align-items-center border-bottom pb-2">
                            ...
                            <x-secondary-lang-toggle for="sub-category-create" class="ms-auto" :checked="$hasSecondarySub" />
                        </div>
                        ...
                        <x-secondary-lang-fields for="sub-category-create" :show="$hasSecondarySub">
                            <div class="mt-3">
                                <x-input label="{{ __('Name') }} ({{ secondary_language_title() }})" name="name_secondary" type="text" placeholder="{{ secondary_language_title() }} Name" :value="old('name_secondary')" />
                            </div>

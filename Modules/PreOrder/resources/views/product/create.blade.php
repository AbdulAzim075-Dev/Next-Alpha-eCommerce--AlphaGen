@extends('layouts.app')
@section('header-title', __(' New Pre Order Product'))
@section('content')
    <div class="page-title">
        <div class="d-flex gap-2 align-items-center">
            {{ __(' Add Pre Order Product') }}
        </div>
    </div>
    <form action="{{ route('shop.preOrder.product.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 mt-2">
                                        <x-input type="text" name="expected_delivery_date" label="Expected Delivery Date"
                                            placeholder="10 hours ,3 days,7-10 days" required="true" />
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-4 col-md-6">
                                        <x-input type="text" name="buy_price" label="Buying Price"
                                            placeholder="Buying Price" required="true" onlyNumber="true" />
                                    </div>
                                    <div class="col-lg-4 col-md-6">
                                        <x-input type="text" name="price" label="Selling Price"
                                            placeholder="Selling Price" required="true" onlyNumber="true"
                                            value="10" />
                                    </div>
                                    ...
                                    <div class="col-lg-3 col-md-4 mt-3">
                                        <x-input type="number" min="1" name="min_order_quantity"
                                            label="Min Quantity" placeholder="Minimum Order Quantity"
                                            value="1" />
                                    </div>
                                    <div class="col-lg-3 col-md-4 mt-3">
                                        <x-input type="number" min="1" name="preorder_quantity_limit"
                                            label="Max Quantity" placeholder="Preorder Quantity Limit"
                                            value="1" />
                                    </div>
                                    <div class="col-lg-4 col-md-4 mt-3">
                                        <x-input type="text" onlyNumber="true" name="prepay_amount"
                                            label="Prepay Amount" placeholder=" prepay Amount" value="1" />
                                    </div>
                                ...
                                <div class="mt-1 d-flex gap-2">
                                    <div class="mb-1">
                                        ...
                                        <select class="form-select" name="uploadVideo[type]" id="uploadType"
                                            ...
                                            <option value="file"
                                                {{ old('uploadVideo.type') == 'file' ? 'selected' : '' }}>
                                                {{ __('Upload Video File') }}
                                            </option>
                                            <option value="youtube"
                                                {{ old('uploadVideo.type') == 'youtube' ? 'selected' : '' }}>
                                                {{ __('YouTube Link') }}
                                            </option>
                                            <option value="vimeo"
                                                {{ old('uploadVideo.type') == 'vimeo' ? 'selected' : '' }}>
                                                {{ __('Vimeo Link') }}
                                            </option>
                            ...
                            <div class="card-body">
                                ...
                                <div class="mt-1">
                                    ...
                                    <textarea required name="preorder_notice" class="form-control @error('preorder_notice') is-invalid @enderror"
                                        rows="4" placeholder="Enter preorder notice">{{ old('preorder_notice') }}</textarea>
